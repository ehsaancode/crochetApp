                ...
                <div className="text-center py-24 px-8 md:px-32 mb-32 rounded-3xl bg-gradient-to-b from-transparent to-silk-200 dark:from-black dark:to-[#170D27]">
                    <FadeContent blur={true} duration={1000} easing="ease-out" initialOpacity={0}>
                        ...
                        <Link to="/custom-order">
                            <button className="bg-silk-900 dark:bg-silk-100 text-white dark:text-black text-sm h-10 px-6 rounded-full font-medium transition-all hover:bg-silk-800 dark:hover:bg-white shadow-md hover:shadow-lg">
                                Upload an image
                            </button>
                        </Link>
                    </FadeContent>
