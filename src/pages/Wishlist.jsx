...
const Wishlist = () => {
    ...
    return (
        <div className='border-t pt-14 px-4 sm:px-12 md:px-24 min-h-screen pb-12'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 gap-y-10'>
                {userData.wishlist.map((item, index) => {
                    ...
                    return (
                        <FadeContent key={index} blur={true} duration={0.4} delay={index * 0.05}>
                            <div className='group relative border border-silk-100 dark:border-silk-800 rounded-xl overflow-hidden bg-white dark:bg-black/20 hover:shadow-lg transition-all duration-300'>
                                    ...
                                    {isAvailable ? (
                                        <>
                                            ...
                                            <div className='flex gap-2'>
                                                ...
                                                <button
                                                    onClick={() => addToCart(productData._id, productData.sizes[0] || 'Default')} // Default size selection? Better to view details. But standard is cart.
                                                    // Actually, forcing user to view details for size is safer.
                                                    // I'll make both buttons go to view details or just one main button.
                                                    // Wait, requirement: "user can... click to view the product".
                                        ...
                                        <>
                                            ...
                                            <p className="text-red-500 text-xs font-semibold mb-3">Out of Stock / Discontinued</p>
